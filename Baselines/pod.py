...
if __name__ == "__main__":
    ...
    print(vortex_data.shape, noaa_data.shape, chaotic_data.shape)
    ...
    t0 = 200
    anim_duration = 40
    anim_save_path = "Video/vortex_pod_10_basis"
    ...
    # plt.plot(S, linewidth=0, marker='o')
    # plt.show()

    # basis0 = pod_basis[:, 1].reshape([2, 30, 30])
    # plt.imshow(basis0[1, :, :])
    # plt.show()
