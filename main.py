...
if __name__ == '__main__':
    ...
    noaa_data = np.load("Data/Processed/noaa_flow_field_minmax_scaled.npy")
    chaotic_vorticity_40by40 = np.load("Data/Processed/chaotic_40by40_vorticity_standard_scaled.npy").reshape([4000, 1, 40, 40]) 
    chaotic_flow_field_40by40 = np.load("Data/Processed/chaotic_40by40_flow_field_standard_scaled.npy").reshape([4000, 2, 40, 40])
    training_data = chaotic_vorticity_40by40
